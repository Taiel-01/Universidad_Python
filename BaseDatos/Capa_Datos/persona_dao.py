...
class PersonaDao:
    ...
    def insertar(cls, persona):
        try:
            ...
            conexion.rollback()
            logger.error(f'Exepcion al insertar persona:{e}')
        finally:
            Conexion.cerrar()
    ...
    def actualizar(cls, persona):
        try:
            ...
            conexion.rollback()
            logger.error(f'Exepcion al actualizar persona:{e}')
        finally:
            Conexion.cerrar()
    ...
    def eliminar(cls, persona):
        try:
            ...
            conexion.rollback()
            logger.error(f'Exepcion al eliminar persona:{e}')
        finally:
            Conexion.cerrar()
...
if __name__ == '__main__':
    ...
    # persona = Persona(nombre='Pedro', apellido='Najera', email='pnajera@mail')
    # personas_insertadas = PersonaDao.insertar(persona)
    # logger.debug('Registros insertadas" {personas_insertadas}')
